...
typedef struct __mavlink_statustext_t {
 uint16_t msgid; /*<  indicate statustext msgid,0 for info ,100-1000 for other*/
...
#define MAVLINK_MSG_ID_STATUSTEXT_LEN 53
#define MAVLINK_MSG_ID_STATUSTEXT_MIN_LEN 53
#define MAVLINK_MSG_ID_253_LEN 53
#define MAVLINK_MSG_ID_253_MIN_LEN 53

#define MAVLINK_MSG_ID_STATUSTEXT_CRC 37
#define MAVLINK_MSG_ID_253_CRC 37
...
#define MAVLINK_MESSAGE_INFO_STATUSTEXT { \
    ...
    {  { "severity", NULL, MAVLINK_TYPE_UINT8_T, 0, 2, offsetof(mavlink_statustext_t, severity) }, \
         { "msgid", NULL, MAVLINK_TYPE_UINT16_T, 0, 0, offsetof(mavlink_statustext_t, msgid) }, \
 ...
 * @param msgid  indicate statustext msgid,0 for info ,100-1000 for other
...
static inline uint16_t mavlink_msg_statustext_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint8_t severity, uint16_t msgid, const char *text)
{
...
{
    return mavlink_msg_statustext_pack(system_id, component_id, msg, statustext->severity, statustext->msgid, statustext->text);
}
...
{
    return mavlink_msg_statustext_pack_chan(system_id, component_id, chan, msg, statustext->severity, statustext->msgid, statustext->text);
}
...
static inline void mavlink_msg_statustext_send(mavlink_channel_t chan, uint8_t severity, uint16_t msgid, const char *text)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_STATUSTEXT_LEN];
    _mav_put_uint16_t(buf, 0, msgid);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_statustext_send(chan, statustext->severity, statustext->msgid, statustext->text);
#else
 ...
 */
static inline void mavlink_msg_statustext_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t severity, uint16_t msgid, const char *text)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field msgid from statustext message
 *
 * @return  indicate statustext msgid,0 for info ,100-1000 for other
 */
static inline uint16_t mavlink_msg_statustext_get_msgid(const mavlink_message_t* msg)
{
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    statustext->msgid = mavlink_msg_statustext_get_msgid(msg);
